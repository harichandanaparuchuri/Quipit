...
<body>
<div id="wrapper">
    <form method="POST" action="newEmptyPHP1.php.php" onsubmit="return Validate()" name="vForm">
		<div>
...
<script type="text/javascript">
	...
	var password_confirmation = document.forms["registerform"]["password_confirmation"];
